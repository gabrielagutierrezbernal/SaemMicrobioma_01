...
> **Nota:** este es un ejemplo mínimo de uso con pocos sujetos. Con un tamaño
> de muestra chico, los estimados de un único ajuste traen ruido de muestreo y
> pueden quedar lejos de los valores verdaderos usados en la simulación; no es
> un problema del método. Para la validación estadística (al aumentar el número
