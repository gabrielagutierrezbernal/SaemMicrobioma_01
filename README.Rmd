...
`saemMicrobiome` implementa dos modelos mixtos con inflación de ceros para
...
Ambos modelos y su algoritmo de estimación fueron desarrollados originalmente
por John Barrera:
...
> **Nota:** el ejemplo usa 300 sujetos, un tamaño de muestra suficiente para
> que los estimados queden cerca de los valores verdaderos usados en la
> simulación (`alpha = c(-0.3, 0.5)`, `beta = c(0.2, -0.4)`, `phi = 15`). Con
> muestras pequeñas, los estimados de un único ajuste traen más ruido de
> muestreo; en la carpeta `estudios/` se muestra cómo el error disminuye al
> aumentar el número de sujetos.
...
> **Nota:** al igual que en el ejemplo ZIBR, se usan 300 sujetos, un tamaño de
> muestra suficiente para que los estimados queden cerca de los valores
> verdaderos usados en la simulación (`alpha = c(-0.3, 0.5)`,
> `beta = c(0.2, -0.4)`, `phi = 15`). Con muestras pequeñas, los estimados de un
> único ajuste traen más ruido de muestreo; en la carpeta `estudios/` se muestra
> cómo el error disminuye al aumentar el número de sujetos.
