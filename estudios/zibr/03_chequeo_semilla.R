## ===== CHEQUEO DE SENSIBILIDAD A LA SEMILLA - modelo ZIBR =====
...
png("chequeo_semilla_zibr.png", width = 1100, height = 700, res = 110)
...
par(op)
dev.off()
cat("\nGrafico guardado en: chequeo_semilla_zibr.png\n")
